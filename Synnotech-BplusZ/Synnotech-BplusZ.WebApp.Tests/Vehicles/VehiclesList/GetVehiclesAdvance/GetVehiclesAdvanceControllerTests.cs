...
namespace Synnotech_BplusZ.WebApp.Tests.Vehicles.VehiclesList.GetVehiclesAdvance
{
    public class GetVehiclesAdvanceControllerTests
    {
        ...
        public async Task GetVehicles_WithDto_ReturnsOkResult()
        {
            ...
            _getVehiclesContext.Setup(context => context.GetVehiclesAdvance(It.IsAny<GetVehiclesDto>()))
                               .ReturnsAsync(vehicles);

            var response = await _controller.GetVehiclesAdvance(new GetVehiclesDto());
        ...
        public async Task GetVehicles_WithDto_ReturnsRightItem()
        {
            ...
            var response = (await _controller.GetVehiclesAdvance(new GetVehiclesDto())).Result as OkObjectResult;
